...
class View3D(QWidget, QThread):
    ...
    def get_plane_widget(self):
        ...
        if self.plane_widget_Flag == False:
            ...
            self.implicitPlaneWidget.SetInputData(self.appendFilter.GetOutput())
    ...
    def update_reslice(self):
        ...
        self.volumemapper.SetCroppingRegionPlanes(self.size_list[0], self.size_list[1]*0.324,
                               self.size_list[2], self.size_list[3]*0.325,
                               self.size_list[4], self.size_list[5])
